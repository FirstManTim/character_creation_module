...
def attack(char_name: str, char_class: str) -> str:
    """Определяет степень урона в зависимости от вида атаки."""
...
def defence(char_name: str, char_class: str) -> str:
    """Определяет степень блока в зависимости от типа персонажа."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Определяет тип специального умения в зависимости от типа персонажа."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Выводит информацию о выбранном персонаже."""
    if char_class == 'warrior':
...
def choice_char_class():
    """Определяет имя и тип персонажа."""
    approve_choice = None
    char_class = None
